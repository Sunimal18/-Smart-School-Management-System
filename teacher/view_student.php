...
<div class="container my-5">
  <div class="card shadow-lg">
    <div class="card-header bg-info text-white text-center">
      <h4>📘 Student Details  <br> Name - <?= htmlspecialchars($student['name']) ?> <br>Index Number - (<?= htmlspecialchars($student['index_no']) ?>)</h4>
      <p>Class Name - <?= htmlspecialchars($student['class_name']) ?></p>
    </div>
