  ...
  <div class="container">
    <div class="form-container">
      ...
      <form action="sql/insert_student.php" method="POST">
        ...
        <div class="form-group">
          <label for="class_id">Category - 1</label>
          <select name="cat_1_sub" id="class_id" class="form-control" required>
            <option value="">-- Select Category - 1 Subject  --</option>
        ...
        <div class="form-group">
          <label for="class_id">Category - 2</label>
          <select name="cat_2_sub" id="class_id" class="form-control" required>
            <option value="">-- Select Category - 2 Subject  --</option>
        ...
        <div class="form-group">
          <label for="class_id">Category - 3</label>
          <select name="cat_3_sub" id="class_id" class="form-control" required>
            <option value="">-- Select Category - 3 Subject  --</option>
        ...
        <div class="form-group">
          <label for="class_id">Religion</label>
          <select name="religion" id="class_id" class="form-control" required>
